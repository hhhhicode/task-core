...
* The original package name 'io.hcode.task-core' is invalid and this project uses 'io.hcode.task_core' instead.
...
* [Coroutines section of the Spring Framework Documentation](https://docs.spring.io/spring-framework/reference/6.2.11/languages/kotlin/coroutines.html)
